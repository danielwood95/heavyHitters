...
\newcommand{\TITLE}{HashFilter: Filtering Streams of Data for Top-K Heavy Hitters}
\newcommand{\KEYWORDS}{}
\newcommand{\CONFERENCE}{COS 561 Final Project}
...
\usepackage[labelfont={sf,bf}, font={small, sf}]{caption}
